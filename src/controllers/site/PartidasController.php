...
class PartidasController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->loadView('site/partidas', $dados);
    ...
    private function getProxPartidas()
    {
        ...
        foreach ($partidas as $key => $value) {
            ...
            if (($value['data_hora_partida'] > date('Y-m-d H:i:s')) && ($value['concluido'] == 0) && ($value['cancelado'] == 0)) {
                $proxPartidas[] = [
    ...
    private function getUltimosResultados()
    {
        ...
        foreach ($partidas as $value) {
            ...
            if (($value['dt_hora'] < date('Y-m-d H:i:s')) && (count($resultados) < 10) && ($value['concluido'] == 1)) {
                $resultados[] = [
                    'liga' => $value['liga'],
