...
<section class="blog-hero-section set-bg" data-setbg="<?= $base ?>/assets/site/img/blog/details/details-hero.jpg">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="bh-text">
            ...
            <div class="col-lg-8 left-blog-pad">
                <div class="bd-text">
                    ...
                    <div class="bd-pic">
                        <div class="row">
                            <div class="col-md-4">
                                <img src="<?= $base ?>/assets/site/img/blog/details/details-1.jpg" alt="">
                            </div>
                            <div class="col-md-8">
                                <img src="<?= $base ?>/assets/site/img/blog/details/details-2.jpg" alt="">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <img src="<?= $base ?>/assets/site/img/blog/details/details-3.jpg" alt="">
                                    </div>
                                    <div class="col-sm-6">
                                        <img src="<?= $base ?>/assets/site/img/blog/details/details-4.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="comment-option">
                        ...
                        <div class="single-comment-item first-comment">
                            <div class="sc-author">
                                <img src="<?= $base ?>/assets/site/img/blog/details/comment/comment-1.jpg" alt="">
                            </div>
                            <div class="sc-text">
                        ...
                        <div class="single-comment-item reply-comment">
                            <div class="sc-author">
                                <img src="<?= $base ?>/assets/site/img/blog/details/comment/comment-2.jpg" alt="">
                            </div>
                            <div class="sc-text">
                        ...
                        <div class="single-comment-item second-comment ">
                            <div class="sc-author">
                                <img src="<?= $base ?>/assets/site/img/blog/details/comment/comment-3.jpg" alt="">
                            </div>
                            <div class="sc-text">
                                <span>27 Aug 2019</span>
                                <h5>Brandon Kelley</h5>
